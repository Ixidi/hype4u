...
import xyz.ixidi.hype4u.spigot.framework.command.argument.parser.DefaultPlayerParser
import xyz.ixidi.hype4u.spigot.framework.command.argument.parser.DefaultStringParser
import kotlin.reflect.KClass
import kotlin.reflect.full.isSubclassOf

class ArgumentParsersImpl(
    server: Server
) : ArgumentParsers {
