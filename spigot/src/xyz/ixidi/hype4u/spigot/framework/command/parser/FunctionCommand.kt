...
class FunctionCommand(
    ...
    override fun execute(commandSender: CommandSender, args: List<String>) {
        try {
                ...
                when (parameter) {
                    is CommandSenderFunctionParameter -> {
                        if (!parameter.matches(commandSender)) {
                            commandSender.message(TranslatableKey.MESSAGE_COMMAND_SENDER_LEVEL)
                            return
                        }
                    ...
                    is ArgumentFunctionParameter -> {
                        ...
                        if (args.size - 1 < argI) {
                            ...
                            commandSender.message(
                                TranslatableKey.MESSAGE_COMMAND_MISSING_PARAMETER,
                                "error" to error,
            ...
            commandSender.message(
                TranslatableKey.MESSAGE_COMMAND_UNKNOWN_ERROR,
